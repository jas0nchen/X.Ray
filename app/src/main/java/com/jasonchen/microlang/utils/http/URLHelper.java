...
public class URLHelper {
    ...
    public static final String ACESS_TOKEN = "https://api.weibo.com/oauth2/access_token";

    //app information
    public static final String APP_KEY = "412159506";
    public static final String APP_SECRET = "af541cc6a99a6bc93cc5916b7a2591d2";
    public static final String DIRECT_URL = "https://api.weibo.com/oauth2/default.html";

    //hack app information
    public static final String HACK_APP_KEY = "211160679";
    public static final String HACK_APP_SECRET = "63b64d531b98c2dbff2443816f274dd3";
    public static final String HACK_DIRECT_URL = "http://oauth.weico.cc";
    ...
    public static final String SEARCH_STATUSES = URL_SINA_WEIBO + "search/statuses.json";
