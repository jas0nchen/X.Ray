 ...
 * 2015/04/10
 */
public class SyncSizeReadWorker extends AbstractWorker<String, Integer, Boolean> {
    ...
    private TimeLineImageView ISimRayDrawable;

    public String getUrl() {
        return data;
    }

    public SyncSizeReadWorker(ImageView view, String url, FileLocationMethod method,
    ...
    public SyncSizeReadWorker(TimeLineImageView view, String url, FileLocationMethod method,
                              boolean isMultiPictures) {
    ...
    protected void onPostExecute(Boolean result) {
        ...
        if (result) {
            ...
            if (ISimRayDrawable != null) {
                newTask = new SyncSizeLocalWorker(ISimRayDrawable, getUrl(), method,
                        isMultiPictures);
