...
public class MessageBean extends ItemBean implements Parcelable {
    ...
    private transient SpannableString listViewWeiboDetailSpannableString;
    ...
    public static final Creator<MessageBean> CREATOR =
            new Creator<MessageBean>() {
    ...
    public String getCommentscountString(){
        if(comments_count > 10000){
            return Math.round((float)comments_count / 10000) + "万";
        }else{
            return String.valueOf(comments_count);
        }
    }

    public String getRepostscountString(){
        if(reposts_count > 10000){
            return Math.round((float)reposts_count / 10000) + "万";
        }else{
            return String.valueOf(reposts_count);
        }
    }
    ...
    public SpannableString getWeiboDetailSpannableString() {
        if (!TextUtils.isEmpty(listViewWeiboDetailSpannableString)) {
            return listViewWeiboDetailSpannableString;
        } else {
            TimeLineUtility.addWeiboDetailJustHighLightLinks(this);
            return listViewWeiboDetailSpannableString;
        }
    }
    ...
    public void setWeiboDetailListViewSpannableString(SpannableString listViewSpannableString) {
        this.listViewWeiboDetailSpannableString = listViewSpannableString;
    }
