package com.jasonchen.microlang.swipeback;
...
public class SwipeBackLayout extends FrameLayout {
	 ...
	 * callback's
	 * {@link com.jasonchen.microlang.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
	 * and
	 * {@link com.jasonchen.microlang.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
