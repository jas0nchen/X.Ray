...
import com.jasonchen.microlang.dao.StatusNewMsgDao;
...
public class SendWeiboService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        WeiboSendTask task = new WeiboSendTask(lastNotificationId, token, account, picPath, content, visible,
	...
	private class WeiboSendTask extends MyAsyncTask<Void, Long, Void> {
        ...
        protected void onPreExecute() {
            ...
            if (Utility.isJB()) {
                ...
                IntentFilter intentFilter = new IntentFilter(
                        "com.jasonchen.microlang.SendWeiboService.stop." + String.valueOf(
                                notificationId));
                ...
                builder.addAction(R.drawable.ic_status_send_fail, getString(R.string.cancel),
                        pendingIntent);
        ...
        private boolean sendPic(String uploadPicPath) throws WeiboException {
            return new StatusNewMsgDao(token).setVisibility(visible).setPic(uploadPicPath).setGeoBean(geoBean).sendNewMsg(
        ...
        private boolean sendText() throws WeiboException {
            return new StatusNewMsgDao(token).setVisibility(visible).setGeoBean(geoBean).sendNewMsg(content, null);
        }
